...
Finland's historical naval forces in World War II revolved around coastal defense ships (*Väinämöinen*, *Ilmarinen*), submarines (*Vetehinen*, *Vesihiisi*, *Iku-Turso*, *Saukko*, *Vesikko*), gunboats, motor torpedo boats, and minelayers. In vanilla Hearts of Iron IV, Finnish ship namelists are sparse and quickly run dry during Baltic naval expansion campaigns. ISNE provides expansive, historically grounded namelists for both historical coastal defense operations and plausible great-power Baltic expansions across dedicated ship-type classes and 13 universal thematic topic pools.
...
| :--- | :--- | :--- | :--- |
| `FIN_DD_HISTORICAL` | Destroyers & Escorts | `ship_hull_light destroyer` | Hämeenmaa, Uusimaa, Karjala, Turunmaa, Matti Kurki, Klas Horn, Sisu, Hurja, Isku, Syöksy, Nuoli, Louhi, Ruotsinsalmi, Riilahti, Keihässalmi, Uisko, Tursas |
...
| `FIN_CA_HISTORICAL` | Heavy Cruisers & Coastal Defense | `ship_hull_cruiser heavy_cruiser` | Väinämöinen, Ilmarinen, Lemminkäinen, Joukahainen, Kullervo, Tapio, Ahti, Ukko, Pellervo, Ilmatar, Mielikki, Tuonetar, Vipunen, Sammas, Kaleva, Kaukomieli |
| `FIN_BB_HISTORICAL` | Battleships & Capital Ships | `ship_hull_heavy battleship battle_cruiser` | Suomi, Suur-Suomi, Pohjanmaa, Karjala, Uusimaa, Häme, Satakunta, Savo, Varsinais-Suomi, Ahvenanmaa, Lappi, Kainuu, Kuningas Fornjot, Kuningas Norr |
| `FIN_CV_HISTORICAL` | Aircraft Carriers | `ship_hull_carrier carrier` | Kokko, Ilmatar, Ukko, Ilmarinen, Vaakalintu, Taivaankantaja, Merikotka, Maakotka, Kotka, Haukka, Tuulihaukka, Nuolihaukka, Sääksi, Otava, Pohjantähti |
